...
import com.tinuvile.domain.activity.model.valobj.*;
import com.tinuvile.infrastructure.dao.*;
import com.tinuvile.infrastructure.dao.po.*;
...
public class ActivityRepository implements IActivityRepository {
    ...
    public boolean isInWhiteList(String userId) {
        return dccService.isInWhiteList(userId);
    }
