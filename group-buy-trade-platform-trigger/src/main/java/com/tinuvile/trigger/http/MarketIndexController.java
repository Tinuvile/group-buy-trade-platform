...
import com.tinuvile.api.IMarketIndexService;
...
@RestController()
@CrossOrigin("*")
@RequestMapping("/api/v1/gbtp/index")
public class MarketIndexController implements IMarketIndexService {
    ...
    public Response<GoodsMarketResponseDTO> queryGroupBuyMarketConfig(@RequestBody GoodsMarketRequestDTO requestDTO) {
        ...
        try {
            ...
            // 查询拼团组队
            List<UserGroupBuyOrderDetailEntity> userGroupBuyOrderDetailEntities = indexGroupBuyMarketService.queryInProcessUserGroupBuyOrderDetailList(activityId, requestDTO.getUserId(), 1, 2);
